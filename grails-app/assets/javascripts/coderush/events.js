...
var loadEvent = function($scope, $http, $routeParams) {
    ...
    $http.get('/coderush/data/events/' + $routeParams['eventId'], getHttpConfig()).
...
var loadEvents = function($scope, $http) {
    ...
    $http.get('/coderush/data/events/', getHttpConfig()).
        success(function (data) {
...
events.controller('listEventsController',
    function ($scope, $location, $http) {
        ...
        $scope.deleteEvent = function(index) {
            ...
            $http.delete('/coderush/data/events/' + eventId, getHttpConfig()).
                success(function(data) {
...
events.controller('createEventController',
    function ($scope, $location, $http) {
        ...
        $scope.saveEvent = function () {
            ...
            $http.post('/coderush/data/events/', $scope.event, getHttpConfig()).
                success(function (data) {
...
events.controller('editEventController',
    function ($scope, $location, $http, $routeParams) {
        ...
        $scope.saveEvent = function() {
            ...
            $http.put('/coderush/data/events/' + $scope.event.id, $scope.event, getHttpConfig()).
                success(function(data) {
                    console.log('saveEvent success: ' + data);
