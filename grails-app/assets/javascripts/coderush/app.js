var coderushApp = angular.module('coderushApp', [
...
coderushApp.config(['$routeProvider',
...
coderushApp.directive('confirmationNeeded', function () {
    return {
        priority: 1,
        terminal: true,
...
coderushApp.directive('showLogin', function() {
    return {
        restrict: 'C',
...
console.log('coderush app load complete');